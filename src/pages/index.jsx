    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          ...
          <Subtitle>Something, something, intro text goes here.</Subtitle>
        </Hero>
      </Content>
      <DividerMiddle
      ...
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            ...
            >
              Third thing goes here, only have 1/2 or more.
            </ProjectCard>
            <ProjectCard
              title="Four"
              link="https://www.google.com"
            ...
            >
              kjsadlfdj;fjdslkfjlsdfjsklafjladsk;jfdsl;fjdsf
            </ProjectCard>
          </ProjectsWrapper>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          <Title>About</Title>
          <AboutHero>
            <Avatar src={avatar} alt="Tidal Boar" />
            <AboutSub>
              Longer description of the business.
            </AboutSub>
          </AboutHero>
          <AboutDesc>
            Even, longer stuff goes here.
          </AboutDesc>
        </Inner>
      </Content>
